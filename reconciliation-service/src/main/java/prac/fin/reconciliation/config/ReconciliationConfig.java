package prac.fin.reconciliation.config;
...
public class ReconciliationConfig {
	...
	@Bean
	public ConsumerFactory<String, PaymentEventMessage> reconciliationConsumerFactory() {
		JsonDeserializer<PaymentEventMessage> deserializer = new JsonDeserializer<>();
	 ...
	 */
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, PaymentEventMessage> reconciliationListenerFactory() {
	...
	@Bean
	public ProducerFactory<String, PaymentEventMessage> reconciliationProducerFactory() {
		Map<String, Object> config = new HashMap<>();
		...
		return new DefaultKafkaProducerFactory<String, PaymentEventMessage>(config);
	}
	
	@Bean
    public KafkaTemplate<String, PaymentEventMessage> reconciliationKafkaTemplate() {
